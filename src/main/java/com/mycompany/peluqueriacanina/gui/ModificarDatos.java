...
//        this.num_cliente = num_cliente;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\gilbe\\OneDrive\\Imágenes\\img.JPG")); // NOI18N
        ...
        cmbAtenEsp.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "SI", "NO" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        control.modificarMascota(mascota, nombreMasco, raza, color, observaciones, alergico, atenEsp,
                nombreDue, telefono);

        //mensaje de que cumplio correctamente
        mostrarMensaje("Editado correctamente", "Info", "Edicion de datos");
    ...
    private void cargarDatos(int num_cliente) {
        ...
        txtNombreDuenio.setText(mascota.getUnDuenio().getNombre_duenio());
        txtObservaciones.setText(mascota.getObservacion());
        ...
        if (mascota.getAtencion_esp().equals("SI")) {
            cmbAtenEsp.setSelectedIndex(1);
        } else if (mascota.getAtencion_esp().equals("NO")) {
